Реализовано демонстрационное приложение с внедрением SSL-пиннинга, как на сертификат, так и на публичный ключ, с использованием механизмов URLSession и Alamofire.
